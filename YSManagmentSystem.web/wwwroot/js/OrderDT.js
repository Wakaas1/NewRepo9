            ...
            columns: [
                ...
                { data: "total" },
                {
                    data: "id", "render": function (data, type, row) {
                        return '<button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModalCenter" href="" data-url="/Order/OrderItem?id=' + data + '" ><i class="fa fa-edit"></i></button>  <button href="#" class="btn btn-danger" onclick=DelOrd("' + data + '")><i class="fa fa-trash"></i></button>'
                    }, 
                    "Width": "autowidth"
                }
            ],
