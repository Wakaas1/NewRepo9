            ...
            columns: [
...

                {
                    data: "id", "render": function (data, type, row) {
                        return '<button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#exampleModalCenter"  href="" data-url="/Customer/AddOrEditCustomer?id=' + data + '" > <i class="fa fa-edit"></i></button>  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter" href="" data-url="/Customer/DetailCustomer?id=' + data + '" > <i class="fa fa-info"></i></button>  <button href="#" class="btn btn-danger" onclick=DelCus("' + data + '")><i class="fa fa-trash"></i></button>'
                    },
                    "Width": "autowidth"
                }
            ],
