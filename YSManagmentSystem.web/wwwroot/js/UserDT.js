            ...
            columns: [
                ...
                { data: "roles_list", "autoWidth": true },
                {
                    data: "id", "render": function (data, type, row) {
                        return '<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter" href="" data-url="/Role/EditRole?uId=' + data + '" > <i class="fa fa-edit"></i></button> <a href="#" class="btn btn-danger" onclick=DelUser("' + data + '")><i class="fa fa-trash"></i></a>'
                    },
                }
            ],
        });
